...
• AASF is off—bummer, but OK. What to do with pamphlet energy?
	- still send it towards physical output, tangible
	- Ryan's idea for distributed content, may 1000 aesthetics bloom
	- "LG Sandwich" packet idea, black-on-X printed paper
• Finish jekyll transfer
• Ping folks re: layout, provide a template for them to break
• Nurture Are.na post, multimedia essay (w/audio of us talking)
